    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-gray-600">Total Splits</span>
        ...
        <div className="text-3xl font-bold text-gray-900 mb-1">{totalSplits}</div>
        <div className="text-xs text-gray-500">{favoriteSplits} favorites</div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="text-3xl font-bold text-gray-900 mb-1">{totalRecipients}</div>
        <div className="text-xs text-gray-500">Across all splits</div>
      </div>

      {/* Average Recipients */}
      <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-gray-600">Avg Recipients</span>
        ...
        <div className="text-3xl font-bold text-gray-900 mb-1">{avgRecipientsPerSplit}</div>
        <div className="text-xs text-gray-500">Per split</div>
      </div>

      {/* Avg Percentage */}
      <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-gray-600">Avg Share</span>
        ...
        <div className="text-3xl font-bold text-gray-900 mb-1">{avgPercentage}%</div>
